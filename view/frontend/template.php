...
<html lang="fr">
    ...
    <body>
        ...
        <script>
            tinymce.init({
            selector: '#create-title-topic, #title-game, #release-date-game, #type-game , #edit-title-game, #edit-type-game, #edit-date-game, #add-forum, #textarea-cat-forum', menubar: false, toolbar: 'undo redo', branding: false, statusbar: false, entity_encoding: "raw", forced_root_block: false, min_height: 50
            });
            tinymce.init({
