    ...
    <div id="admin-reported-messages-content">
        ...
        ?>
            ...
            <div>
                    ...
                    <p><a href="index.php?action=validMessage&amp;idMessage=<?= $reportedMessage['tm_id'] ?>">Valider</a><a href="index.php?action=removeMessaget&amp;idMessage=<?= $reportedMessage['tm_id'] ?>">Supprimer</a>
                    </p>
            </div>
