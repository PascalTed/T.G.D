    ...
    <div id="admin-create-game-content">
        ...
        <form class="form-tiny-mce" action="index.php?action=createGame" method="post" id="form-create-game" enctype="multipart/form-data">
            ...
            <div>
                ...
                <span id="accepted-file-game">Fichiers acceptés : jpeg ou png, maximum 2Mo.</span>
                <span id="incorrect-file-game" class="messages-create-game">Extension incorrecte.</span>
